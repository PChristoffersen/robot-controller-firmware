...
$SEND_CMD output set ext_out1 3 --enable true    --active button1    --active_mode 1 --passive_mode 0 --primary_lut 1 --secondary_lut 0
$SEND_CMD output set ext_out2 3 --enable true    --active button2    --active_mode 1 --passive_mode 0 --primary_lut 1 --secondary_lut 0

$SEND_CMD output set led1 0     --enable button1    --active true    --active_mode 1 --passive_mode 0 --primary_lut 1 --secondary_lut 0
$SEND_CMD output set led1 1     --enable host_ready --active ext_in1 --active_mode 1 --passive_mode 0 --primary_lut 1 --secondary_lut 0
$SEND_CMD output set led1 2     --enable ext_in1    --active true    --active_mode 2 --passive_mode 0 --primary_lut 1 --secondary_lut 0
